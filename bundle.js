...
function App() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            alert('Please configure API Endpoint first');
  ...
  function _onAiGenerate() {
    _onAiGenerate = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var url, headers, payload, base, sys, truthIds, msgs, res, data, addItems, content, ids, obj, m;
        ...
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (aiOpenAiCompat) {
              ...
              sys = 'You are a 5GC signaling expert. Based on the provided truth (if any), generate a case and return an ordered array of message_ids.';
              truthIds = (Array.isArray(truth) ? truth : []).map(function (m) {
                return m && m.id;
              ...
              msgs = [{
                ...
                role: 'user',
                content: String(aiPrompt || '')
              }];
              if (truthIds) msgs.push({
                role: 'user',
                content: 'truth_ids: ' + truthIds
              });
              payload = {
          ...
          case 22:
            ...
            if (data && Array.isArray(data.message_ids)) {
              ...
              if (ids.length > 0) {
                buildCaseFromIds(ids);
                if (window.showToast) window.showToast('Parsed text and created case: ' + ids.length + ' items', 'success');
              }
            }
            _context2.next = 24;
            break;
      ...
      }, _callee2, null, [[0, 21, 24, 28]]);
    }));
    return _onAiGenerate.apply(this, arguments);
  }
  function collectCaseForAnalysis() {
    var items = (Array.isArray(canvas) ? canvas : []).map(function (ci) {
      var m = ci.msg || {};
  ...
  function applyAiSuggestions(sugs) {
    setCanvas(function (prev) {
      var next = prev.map(function (ci) {
        var s = sugs.find(function (x) {
          return x.uid === ci.uid || String(x.message_id || '') === String(ci.msg && ci.msg.id || '');
        });
        if (s && s.overrides && _typeof(s.overrides) === 'object') {
        ...
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 4:
            ...
            if (aiOpenAiCompat) {
              base = url.replace(/\/+$/, '');
              url = /\/v1$/.test(base) ? base + '/chat/completions' : base;
              sys = 'You are a 5GC signaling expert. Analyze case consistency: ensure identity IEs (e.g., IMSI/SUPI) align across steps, and point out IEs that should not appear in the current flow. Strictly output JSON with schema: {"conflicts":[{key,values,positions}],"alignments":{"ie_key":"value"},"suggestions":[{"uid":"cardUid","overrides":{"ie_key":"value"}}]}.';
              msgs = [{
                role: 'system',
                content: sys
              }, {
  ...
  window.viewerAI.settings = function (s) {
    try {
      ...
      if (s && typeof s.prompt === 'string') setAiPrompt(s.prompt);
    } catch (_) {}
  };
  window.viewerAI.buildFromIds = function (ids) {
    try { if (Array.isArray(ids)) buildCaseFromIds(ids.map(String)); } catch (_) {}
  };
  ...
  React.useEffect(function(){
    try{
      ...
      btnCancel.addEventListener('click', function(){
        try{ backdrop.classList.remove('open'); }catch(_){ }
        try{ panel.classList.remove('open'); panel.classList.add('closing'); }catch(_){ }
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: (tab === 'ai' ? 'bg-pink-600 text-white ' : 'text-zinc-300 ') + 'px-3 py-1.5 rounded-lg flex items-center gap-2',
    onClick: function onClick() {
      return setTab('ai');
    }
  }, /*#__PURE__*/React.createElement(Icon, {
  ...
  }), "Streaming (chat.completions)")), /*#__PURE__*/React.createElement("textarea", {
    ...
    className: "bg-white/5 border border-white/10 rounded-xl p-6 space-y-4"
  }, /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", { className: "flex items-center gap-2 mb-3" }, /*#__PURE__*/React.createElement(IconButton, { icon: "generate", title: "AI Generate Case", onClick: onAiGenerate, disabled: aiBusy || !aiApiUrl }), /*#__PURE__*/React.createElement(IconButton, { icon: "ai", title: "AI Improve IE (Analyze)", onClick: onAiAnalyzeCase, disabled: aiBusy || !aiApiUrl })), /*#__PURE__*/React.createElement("div", {
    className: "font-medium text-zinc-100"
    ...
    className: "text-xs text-zinc-400"
  }, "Changes are auto-saved to browser localStorage and take effect immediately."))))));
}
...
function DropZone(_ref15) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onMouseUp: function onMouseUp(e) {
      // 鍏滃簳锛氳嫢鑷姩鍖栨嫋鎷芥湭瑙﹀�?drop锛屽垯鐢ㄩ紶鏍囨姮璧锋墽�?    
